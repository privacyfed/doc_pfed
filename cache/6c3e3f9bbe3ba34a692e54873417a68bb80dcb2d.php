...
<p>Il codice fornito rappresenta una sezione di una vista di un wizard.</p>

<h2>Struttura del codice</h2>

<p>La vista estende il layout 'ui::layouts.wizard' e visualizza un gruppo di input di tipo select per la selezione dell'azienda.</p>
...
<li>name: il nome dell'input, in questo caso 'company_id';</li>
...
<p>L'array $companies, contenente le opzioni per il menu a tendina, viene passato alla vista dal controller che la renderizza.</p>
