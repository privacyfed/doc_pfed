    ...
    <section class="container max-w-6xl mx-auto px-6 py-10 md:py-12">
        <div class="flex flex-col-reverse mb-10 lg:flex-row lg:mb-24">
            <div class="mt-8">
                ...
                <div class="flex my-10">
                    <a href="<?php echo e(url('/docs/getting-started')); ?>" title="<?php echo e($page->siteName); ?> getting started"
            ...
            <img src="<?php echo e(url('/assets/img/logo-large.svg')); ?>" alt="<?php echo e($page->siteName); ?> large logo"
        ...
        <div class="md:flex -mx-2 -mx-4">
            <div class="mb-8 mx-3 px-2 md:w-1/3">
                <img src="<?php echo e(url('/assets/img/icon-window.svg')); ?>" class="h-12 w-12" alt="window icon">
            ...
            <div class="mb-8 mx-3 px-2 md:w-1/3">
                <img src="<?php echo e(url('/assets/img/icon-terminal.svg')); ?>" class="h-12 w-12" alt="terminal icon">
            ...
            <div class="mx-3 px-2 md:w-1/3">
                <img src="<?php echo e(url('/assets/img/icon-stack.svg')); ?>" class="h-12 w-12" alt="stack icon">
...
<?php echo $__env->make('_layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/_bases/base_pfed/laravel/Modules/PFed/docs/source/index.blade.php ENDPATH**/ ?>